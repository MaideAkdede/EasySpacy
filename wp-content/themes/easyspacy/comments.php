...
?>
<h2 class="comments__title">Commentaires <span class="comment_number"><?= get_comments_number() ?></span></h2>
...
<?php else: ?>
    <div class="comment">
        <p class="comment__empty">Soyez le premier à écrire un commentaire !</p>
    </div>
<?php endif; ?>
